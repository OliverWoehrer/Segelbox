...
// MPU9250 Registers (Motion Sensor):
...
namespace GY91 {
    ...
    typedef struct {
        ...
        float pitch;
        float yaw;
    } orientation_t; // holds the orientation angles
    ...
    int init(TaskFunction_t readSensorDataFunc);
    void enable();
    void disable();
